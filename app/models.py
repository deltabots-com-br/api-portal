...
class User(Base):
    ...
    password = Column(String(255), nullable=False) # Armazenará o hash
    role = Column(String(50), default="client_admin", nullable=False) # superadmin, client_admin
...
class RpaBot(Base):
    ...
    code = Column(String(50), unique=True, nullable=False) # Código para filtrar logs
